...
function fetchChartInfo() {
  ...
  setInterval(fetchChartInfo, 60000); // every minute
  </script>
</body>
</html>
)rawliteral";
...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <form action="/set">
                <label for="mqtt_temp_topic">MQTT Temperature topic:</label>
                <input type="text" 
                       id="mqtt_temp_topic" 
                       name="mqtt_temp_topic" 
                       value="%MQTT_TEMP_TOPIC_PLACEHOLDER%" 
                       maxlength="100" 
                       pattern="^[a-zA-Z0-9_/]+$"
                       title="Please enter a valid path (e.g. home/livingroom/temperature)">
                <input type="submit" value="Save">
            </form>
        </div>
        <div class="card">
